...
function createKatjuscha ( x, y, z, rx, ry, rz )
	...
	vioSetElementData ( katjuschaArray[katjCount]["vehicle"], "katjuscha", true )
	vioSetElementData ( katjuschaArray[katjCount]["vehicle"], "fireAble", true )
	vioSetElementData ( katjuschaArray[katjCount]["vehicle"], "katjuschaID", katjCount )
	for i = 1, 4 do
