...
vioSetElementData ( PnsSFWangCars, "gateID", 19 )
vioSetElementData ( PnsLVCity, "gateID", 36 )
vioSetElementData ( PnsFortCarson, "gateID", 41 )
vioSetElementData ( PnsIdleWood, "gateID", 8 )
vioSetElementData ( PnsDillimore, "gateID", 47 )
vioSetElementData ( PnsTemple, "gateID", 11 )
vioSetElementData ( PnsBeach, "gateID", 12 )
vioSetElementData ( PnsSFJuniperHill, "gateID", 27 )
			...
			if vioGetElementData ( player, "money" ) >= paynsprayprice then
				...
				if (source == PnsSFWangCars and z > 37 and z < 46) or source ~= PnsSFWangCars then
					if getVehicleType ( hitElement ) ~= "Plane" and getVehicleType ( hitElement ) ~= "Helicopter" and getVehicleType ( hitElement ) ~= "Boat" and getVehicleType ( hitElement ) ~= "Train" and getVehicleType ( hitElement ) ~= "Trailer" then
						...
						if isGarageOpen ( vioGetElementData ( source, "gateID" ) ) == true then
							setGarageOpen ( vioGetElementData ( source, "gateID" ), false )
						end
						setTimer ( repairthiscarinpaynspray, 3000, 1, hitElement, player, vioGetElementData ( source, "gateID" ) )
					end									
				end
			else
