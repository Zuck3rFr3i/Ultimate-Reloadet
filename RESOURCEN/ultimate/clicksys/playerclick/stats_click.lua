...
function createStatsWindow()
	...
	elseif buttonText == "Achiev-\nments" then
		...
		gLabel["warnsWert"] = guiCreateLabel(65,92,109,18,vioClientGetElementData("warns"),false,gWindow["stats"])
		...
		gLabel["mordeWert"] = guiCreateLabel(117,169,109,18,vioClientGetElementData("GangwarKills"),false,gWindow["stats"])
		...
		gLabel["todeWert"] = guiCreateLabel(112,191,109,18,vioClientGetElementData("GangwarTode"),false,gWindow["stats"])
		...
		gLabel["gewonnenAnzahl"] = guiCreateLabel(142,213,109,18,vioClientGetElementData("AnzahlGangwarsGewonnen"),false,gWindow["stats"])
		...
		gLabel["verlorenAnzahl"] = guiCreateLabel(129,236,109,18,vioClientGetElementData("AnzahlGangwarsVerloren"),false,gWindow["stats"])
		...
		gLabel["paeckchenWert"] = guiCreateLabel(155,258,109,18,(vioClientGetElementData("foundpackages" ).."/25"),false,gWindow["stats"])
		...
		gLabel["bonuspunkteWert"] = guiCreateLabel(102,283,109,18,vioClientGetElementData ( "bonuspoints"),false,gWindow["stats"])
		...
		gLabel["geldWert"] = guiCreateLabel(123,330,109,18,mymoney.."/"..vioClientGetElementData("bankmoney").." $",false,gWindow["stats"])
