...
function ShowSelfClickMenue_func()
	...
	if gWindows["selfclick"] then
		...
		gWindows["selfclick"] = guiCreateStaticImage(screenwidth/2-291, 10, 582, 110, "images/self/dock.png", false)
		
		img_stats = guiCreateStaticImage(20, 12, 50, 50, "images/self/status.png", false, gWindows["selfclick"])
		gButtons["selfstatus"] = guiCreateButton(20, 0, 50, 50, " ", false, gWindows["selfclick"])
		guiSetAlpha(gButtons["selfstatus"], 0)
		
		img_settings = guiCreateStaticImage(90, 12, 50, 50, "images/self/settings.png", false, gWindows["selfclick"])
		gButtons.selfoptions = guiCreateButton(90, 0, 50, 50, " ", false, gWindows["selfclick"])
		guiSetAlpha(gButtons["selfoptions"], 0)
		
		img_admin = guiCreateStaticImage(230, 12, 50, 50, "images/self/admin.png", false, gWindows["selfclick"])
		gButtons["selfadmin"] = guiCreateButton(230, 0, 50, 50, " ", false, gWindows["selfclick"])
		guiSetAlpha(gButtons["selfadmin"], 0)
		
		img_close = guiCreateStaticImage(510, 12, 50, 50, "images/self/close.png", false, gWindows["selfclick"])
		gButtons["selfcancel"] = guiCreateButton(510, 0, 50, 50, " ", false, gWindows["selfclick"])
		guiSetAlpha(gButtons["selfcancel"], 0)
		
		img_handy = guiCreateStaticImage(300, 12, 50, 50, "images/self/handy.png", false, gWindows["selfclick"])
		gButtons["selfhandy"] = guiCreateButton(300, 0, 50, 50, " ", false, gWindows["selfclick"])
		guiSetAlpha(gButtons["selfhandy"], 0)
		
		img_friend = guiCreateStaticImage(370, 12, 50, 50, "images/self/friendlist.png", false, gWindows["selfclick"])
		gButtons["selffriendlist"] = guiCreateButton(370, 0, 50, 50, " ", false, gWindows["selfclick"])
		guiSetAlpha(gButtons["selffriendlist"], 0)
		
		img_notes = guiCreateStaticImage(440, 12, 50, 50, "images/self/notes.png", false, gWindows["selfclick"])
		gButtons["selfnotes"] = guiCreateButton(440, 0, 50, 50, " ", false, gWindows["selfclick"])
		guiSetAlpha(gButtons["selfnotes"], 0)
		
		img_anim = guiCreateStaticImage(160, 12, 50, 50, "images/self/emotes.png", false, gWindows["selfclick"])
