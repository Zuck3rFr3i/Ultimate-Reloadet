function stripperAnimations ()
	...
	for i = 1, 7 do
		...
		vioSetElementData ( _G["nuttedance"..i], "sx", x )
		vioSetElementData ( _G["nuttedance"..i], "sy", y )
		vioSetElementData ( _G["nuttedance"..i], "sz", z )
		vioSetElementData ( _G["nuttedance"..i], "dim", 0 )
		if i <= 4 then
			vioSetElementData ( _G["nuttedance"..i], "int", 3 )
		else
			vioSetElementData ( _G["nuttedance"..i], "int", 2 )
		end
		vioSetElementData ( _G["nuttedance"..i], "rot", getPedRotation ( _G["nuttedance"..i] ) )
		vioSetElementData ( _G["nuttedance"..i], "botname", "nuttedance"..i )
	end
