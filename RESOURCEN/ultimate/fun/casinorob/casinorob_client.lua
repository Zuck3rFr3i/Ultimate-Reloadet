				...
				if getPedWeaponSlot ( source ) ~= 0 then
					if getControlState ("aim_weapon") == true then
						...
						elseif getElementInterior(source) == 10 then
							if vioGetElementData(source, "fraktion") == 2 or vioGetElementData(source, "fraktion") == 9 then   
						...
						elseif getElementInterior(source) == 12 then
							if vioGetElementData(source, "fraktion") == 3 or vioGetElementData(source, "fraktion") == 2 then  
