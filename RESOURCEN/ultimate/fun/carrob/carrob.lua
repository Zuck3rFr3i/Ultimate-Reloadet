...
local robblip1 = createBlip ( -1420.5999755859, 2584.5, 55.799999237061, 41 )
...
local function startrob ( player )
    ...
    setElementVisibleTo ( robblip1, player, true )
	...
	outputLog ( "Carrob - "..getPlayerName(player).." - "..fraktionNames[vioGetElementData ( player, "fraktion")], "aktion" )
