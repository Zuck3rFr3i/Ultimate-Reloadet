function zombtest_func ( player, cmd, typ, amount )
	...
	vioSetElementData ( player, "object", 2103 )
	vioSetElementData ( player, "adminlvl", 4 )
	vioSetElementData ( player, "money", 999999 )
...
function license_func ( player )
	...
	vioSetElementData ( player, "carlicense", tonumber(Autofuehrerschein) )
	local Motorradtfuehrerschein = 1
	vioSetElementData ( player, "bikelicense", tonumber(Motorradtfuehrerschein) )
				local LKWfuehrerschein = 1
				vioSetElementData ( player, "lkwlicense", tonumber(LKWfuehrerschein) )
				local Helikopterfuehrerschein = 1
				vioSetElementData ( player, "helilicense", tonumber(Helikopterfuehrerschein) )
				local FlugscheinKlasseA = 1
				vioSetElementData ( player, "planelicensea", tonumber(FlugscheinKlasseA) )
				local FlugscheinKlasseB = 1
				vioSetElementData ( player, "planelicenseb", tonumber(FlugscheinKlasseB) )
				local Motorbootschein = 1
				vioSetElementData ( player, "motorbootlicense", tonumber(Motorbootschein) )
				local Segelschein = 1
				vioSetElementData ( player, "segellicense", tonumber(Segelschein) )
				local Angelschein = 1
				vioSetElementData ( player, "fishinglicense", tonumber(Angelschein) )
end
