...
--[[ 
	[ USERBACKUP ]
		...
		Ticketwindow = guiCreateWindow(0.33, 0.32, 0.33, 0.43, "Ticketsystem [NAME]", true)
		...
		TickettextEdit = guiCreateMemo(0.03, 0.26, 0.38, 0.49, "Text..................", true, Ticketwindow)
		...
		guiComboBoxAddItem(Ticketcombobox, "Fragen")
		guiComboBoxAddItem(Ticketcombobox, "Support - Hilfe")
		...
		guiGridListAddColumn(Ticketgridlist, "ID", 0.2)
		guiGridListAddColumn(Ticketgridlist, "Betreff", 0.2)
		guiGridListAddColumn(Ticketgridlist, "Kategorie", 0.2)
		guiGridListAddColumn(Ticketgridlist, "Datum", 0.2)
		guiGridListAddColumn(Ticketgridlist, "Status", 0.2)
...
--[[
	[ ADMINBACKUP ]
		...
		TicketAdminwindow = guiCreateWindow(0.33, 0.32, 0.33, 0.43, "Ticketsystem [NAME]", true)
		guiWindowSetMovable(TicketAdminwindow, false)
		guiWindowSetSizable(TicketAdminwindow, false)

		TicketreasonAdminEdit = guiCreateEdit(0.03, 0.14, 0.38, 0.11, "Ticket von: BliBlu Betreff: SDM", true, TicketAdminwindow)
		TicketlabelAdmin1 = guiCreateLabel(0.04, 0.09, 0.32, 0.04, "Ticket erstellen", true, TicketAdminwindow)
		...
		TickettextAdminEdit = guiCreateMemo(0.03, 0.26, 0.38, 0.49, "Text..................", true, TicketAdminwindow)
		...
		TicketAdmincombobox = guiCreateComboBox(0.03, 0.81, 0.26, 0.15, "Antworten + Schließen", true, TicketAdminwindow)
		...
		guiGridListAddColumn(TicketAdmingridlist, "ID", 0.2)
		guiGridListAddColumn(TicketAdmingridlist, "Betreff", 0.2)
		guiGridListAddColumn(TicketAdmingridlist, "Kategorie", 0.2)
		guiGridListAddColumn(TicketAdmingridlist, "Datum", 0.2)
		guiGridListAddColumn(TicketAdmingridlist, "Status", 0.2)
...
-- TICKETSYSTEM GUI FOR USER --
Ticketwindow = guiCreateWindow(0.33, 0.32, 0.33, 0.43, "Ticketsystem Ultimate Reallife", true)
guiWindowSetMovable(Ticketwindow, false)
guiWindowSetSizable(Ticketwindow, false)
...
TicketAdminwindow = guiCreateWindow(0.33, 0.32, 0.33, 0.43, "Ticketsystem Ultimate Reallife", true)
guiWindowSetMovable(TicketAdminwindow, false)
guiWindowSetSizable(TicketAdminwindow, false)
