...
function getTotalAddictLevel ( player )
	...
	local points1 = vioGetElementData and vioGetElementData ( player, "cigarettAddictPoints" ) or vioClientGetElementData ( "cigarettAddictPoints" )
	local points2 = vioGetElementData and vioGetElementData ( player, "alcoholAddictPoints" ) or vioClientGetElementData ( "alcoholAddictPoints" )
	local points3 = vioGetElementData and vioGetElementData ( player, "drugAddictPoints" ) or vioClientGetElementData ( "drugAddictPoints" )
...
function getCigarettAddictLevel ( player )
	...
	if isElement ( player ) then
		local points = vioGetElementData and vioGetElementData ( player, "cigarettAddictPoints" ) or vioClientGetElementData ( "cigarettAddictPoints" )
...
function getAlcoholAddictLevel ( player )
	...
	if isElement ( player ) then
		local points = vioGetElementData and vioGetElementData ( player, "alcoholAddictPoints" ) or vioClientGetElementData ( "alcoholAddictPoints" )
...
function getDrugAddictLevel ( player )
	...
	if isElement ( player ) then
		local points = vioGetElementData and vioGetElementData ( player, "drugAddictPoints" ) or vioClientGetElementData ( "drugAddictPoints" )
