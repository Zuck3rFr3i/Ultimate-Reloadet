...
local CurrentVarioDiff = 0
function loadAircraftFX()
attitudeIndicator = dxCreateTexture("cockpit/grafik/attitude_indicator.png" , "argb", true,"clamp" )
altimeter1 = dxCreateTexture("cockpit/grafik/altimeter_1.png" , "argb", true,"clamp" )
variometer = dxCreateTexture("cockpit/grafik/variometer.png" , "argb", true,"clamp" )
altimeterPointer1 = dxCreateTexture("cockpit/grafik/altimeter_pointer_1.png" , "argb", true,"clamp" )
altimeterPointer2 = dxCreateTexture("cockpit/grafik/altimeter_pointer_2.png" , "argb", true,"clamp" )
airspeedIndicator = dxCreateTexture("cockpit/grafik/airspeed_indicator.png" , "argb", true,"clamp" )
compass1 = dxCreateTexture("cockpit/grafik/compass_1.png" , "argb", true,"clamp" )
compass2 = dxCreateTexture("cockpit/grafik/compass_2.png" , "argb", true,"clamp" )
corner1 = dxCreateTexture("cockpit/grafik/corner_1.png" , "argb", true,"clamp" )
corner2 = dxCreateTexture("cockpit/grafik/corner_2.png" , "argb", true,"clamp" )
ledon = dxCreateTexture("cockpit/grafik/led_on.png" , "argb", true,"clamp" )
ledoff = dxCreateTexture("cockpit/grafik/led_off.png" , "argb", true,"clamp" )
end
addEventHandler("onClientResourceStart",resourceRoot,loadAircraftFX)
function renderAircraftFX()
 if isPedInVehicle(getLocalPlayer()) then
	local theVehicle = getPedOccupiedVehicle(getLocalPlayer())
	if not theAircraft then
		theAircraft = theVehicle
	end
	if not isElement ( theAircraft ) then
		return
	end
	--=============corner==========================--
	...
	local vario = CurrentVarioDiff * 1.9438444924574 * 8
	if vario > 10 then
		vario = 10
...
function CheckForAircraftEnter(thePlayer, seat)
	...
	if vehType == "Plane" or vehType == "Helicopter" and thePlayer == getLocalPlayer() and seat == 0 then
		lastVehicle = "Plane"
		theAircraft = theVehicle
...
addEventHandler("onClientVehicleStartExit",getRootElement(),CheckForAircraftExit)