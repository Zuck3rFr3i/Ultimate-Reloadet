local Eingang_PD = createMarker ( 217.8037109375, 117.1357421875, 999, "corona", 1.5, 255, 0, 0 )
local Eingang_Knast = createMarker ( 2421.533203125, -1302.83984375, 988.2, "corona", 1.5, 255, 0, 0 )
...
addEventHandler( "onMarkerHit", Eingang_PD, 
	function ( ele, dim )
		...
		if dim and getElementType(ele) == "player" then
			...
			if vioGetElementData ( ele, "jailtime" ) == 0 and vioGetElementData ( ele, "prison" ) == 0 then
